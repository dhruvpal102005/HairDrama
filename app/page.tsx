  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <div className="flex gap-4">
          <SignedOut>
            ...
            <SignUpButton mode="modal">
              <button className="px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition shadow-md">
                Get Started
              </button>
            </SignUpButton>
          </SignedOut>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <SignedOut>
          <SignUpButton mode="modal">
            <button className="px-8 py-4 text-lg font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-lg transition">
              Start Creating Now
            </button>
          </SignUpButton>
        </SignedOut>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-900">AI Generation</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-900">Quality Control</h3>
            <p className="text-gray-600">
      ...
      {/* Footer */}
      <footer className="container mx-auto px-4 py-8 mt-20 border-t border-gray-200 text-center text-gray-600">
